...
from UQpy.distributions.collection import JointCopula, JointIndependent, Normal, Uniform
...
class PolynomialBasis(ABC):
    ...
    def calculate_total_degree_set(inputs_number: int, degree: int):
        ...
        for i in range(degree + 1):
            ...
            # recursive call
            midx_set[row_start : row_end + 1, :] = PolynomialBasis.calculate_total_degree_recursive(
                inputs_number, i, rows
            )
