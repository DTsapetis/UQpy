...
Numpy2DFloatArray = Annotated[
    np.ndarray, Is[lambda array: array.ndim == 2 and np.issubdtype(array.dtype, float)]
]
NumpyFloatArray = Annotated[np.ndarray, Is[lambda array: np.issubdtype(array.dtype, float)]]
NumpyIntArray = Annotated[np.ndarray, Is[lambda array: np.issubdtype(array.dtype, int)]]
