...
def test_rect_gerss():
    ...
    refinement = GradientEnhancedRefinement(
        strata=x.strata_object, runmodel_object=rmodel, surrogate=gpr, nearest_points_number=4
    )
...
def test_vor_rss():
    ...
    x_vor = TrueStratifiedSampling(
        distributions=marginals, strata_object=strata_vor, nsamples_per_stratum=1
    )
