...
def test_kernel_projection():
    ...
    xk = GrassmannPoint(
        np.array([[-0.69535592, -0.0546034], [-0.34016974, -0.85332868], [-0.63305978, 0.51850616]])
    )
    points = [xi, xj, xk]
    k = ProjectionKernel()
    ...
    assert np.allclose(
        kernel, np.array([[2, 1.0063, 1.2345], [1.0063, 2, 1.0101], [1.2345, 1.0101, 2]])
    )
...
def test_kernel_binet_cauchy():
    ...
    assert np.allclose(
        kernel, np.array([[1, 0.0063, 0.2345], [0.0063, 1, 0.0101], [0.2345, 0.0101, 1]])
    )
...
def test_kernel_gaussian_1d():
    ...
    assert np.allclose(
        ...
        np.array([[1.0, 0.26447726, 1.0], [0.26447726, 1.0, 0.26447726], [1, 0.26447726, 1]]),
        atol=1e-04,
    )
...
def test_kernel_gaussian_2d():
    ...
    xk = np.array(
        [[-0.69535592, -0.0546034], [-0.34016974, -0.85332868], [-0.63305978, 0.51850616]]
    )
    points = [xi, xj, xk]
