...
marginals = [Exponential(loc=1.0, scale=1.0), Exponential(loc=1.0, scale=1.0)]
...
sts_vor_obj = TrueStratifiedSampling(
    distributions=marginals, strata_object=strata_obj, random_state=3
)
...
sts_vor_obj1 = TrueStratifiedSampling(
    distributions=marginals, strata_object=strata_obj, random_state=1
)
