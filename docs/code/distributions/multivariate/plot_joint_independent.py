...
from UQpy.distributions.collection import JointIndependent, Lognormal, Normal
...
marginals = [Normal(loc=2.0, scale=2.0), Lognormal(s=1.0, loc=0.0, scale=np.exp(5))]
...
dist.update_parameters(loc_1=1.0, scale_0=3.0)
print("Parameters of the marginals:")
print([m.parameters for m in marginals])
print("Parameters of the joint:")
print(dist.get_parameters())
