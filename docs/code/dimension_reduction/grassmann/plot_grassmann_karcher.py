...
karcher_psi = GrassmannOperations.karcher_mean(
    grassmann_points=manifold_projection.u,
    distance=distance_method,
    optimization_method="GradientDescent",
)
karcher_phi = GrassmannOperations.karcher_mean(
...
points_tangent = GrassmannOperations.log_map(
    grassmann_points=manifold_projection.u, reference_point=karcher_psi
)
...
points_grassmann = GrassmannOperations.exp_map(
