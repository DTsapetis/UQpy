...
true_values = np.array([0.46067666, 0.20474518, 0.11516917, 0.07370827, 0.0511863, 0.03760626])
...
for k in range(num_vars):
    ...
    ax[i][j].semilogx(
        sample_sizes, store_pick_freeze[k, :], "bx-", label="Pick and Freeze estimate"
    )
