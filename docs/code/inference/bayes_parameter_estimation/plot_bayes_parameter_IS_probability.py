...
from UQpy.distributions import JointIndependent, Lognormal, Normal, Uniform
from UQpy.inference import BayesParameterEstimation, DistributionModel
...
bayes_estimator = BayesParameterEstimation(
    sampling_class=sampling, inference_model=candidate_model, data=data, nsamples=50000
)
